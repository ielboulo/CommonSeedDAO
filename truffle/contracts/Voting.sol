...
contract Voting is Ownable {
    ...
    IERC20 seedToken; // how to retreive ? during Deploy script ? 
...
// IEL : à revoir ce code 
        uint minSeedBalance = 100; // minimum SEED balance required to vote
        require(seedToken.balanceOf(msg.sender) >= minSeedBalance, "Insufficient SEED balance");
